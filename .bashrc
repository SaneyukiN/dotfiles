...
# export ROS_HOSTNAME=192.168.100.10
...
alias cn='cmatrix'
alias dycon='rosrun rqt_reconfigure rqt_reconfigure'
...
#source ~/matlab_node/devel/setup.bash

alias scamper='export ROS_HOSTNAME=192.168.25.13 && export ROS_MASTER_URI=http://192.168.25.1:11311 && echo $ROS_HOSTNAME && echo $ROS_MASTER_URI'
alias scamper2="export ROS_MASTER_URI=192.168.25.13"
# cdしたらls
auto_cdls()
{
    if [ "$OLDPWD" != "$PWD" ]; then
...
alias tubame='ssh 18M12330@login.t3.gsic.titech.ac.jp -i ~/.ssh/harada_tubame'
